...
export const metadata: Metadata = {
  title: "Yama Retreat - Premium Japanese Mountain Hotel",
  description: "Experience classical Japanese luxury nestled in serene mountains. Premium hospitality, onsen traditions, and mountain sanctuary awaits.",
  keywords: "Japanese hotel, mountain resort, luxury retreat, onsen, classical design, premium hospitality",
  metadataBase: new URL("https://yamaretreat.com"),
  alternates: {
    canonical: "https://yamaretreat.com"
  },
  openGraph: {
    title: "Yama Retreat - Mountain Sanctuary",
    description: "Discover timeless elegance in the Japanese mountains",
    siteName: "Yama Retreat",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763740425590-257xirxx.jpg",
      alt: "Yama Retreat Mountain View"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Yama Retreat - Premium Mountain Hotel",
    description: "Experience classical Japanese luxury in the mountains",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763740425590-257xirxx.jpg"]
  }
};
